    ...
    where TContext : DbContext
{
    ...
    public async Task<TEntity?> GetAsync(Func<IQueryable<TEntity>, IIncludableQueryable<TEntity, object>>?
                                                           include = null, Expression<Func<TEntity, bool>> predicate = default)
    {
